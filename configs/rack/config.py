...
dataset_dir = gaus_slam_dir.parent/"datasets/rack_10"

scenes = ["20251015_110953_10", "20251015_111153_10", "20251015_111246_10", "20251015_111334_10"]

seed = int(os.environ["SEED"]) if "SEED" in os.environ else 0
scene_name = os.environ["SCENE_NAME"] if "SCENE_NAME" in os.environ else scenes[3]
print(f"Scene name is {scene_name!r}")
...
config = dict(
    vis_base_dir = f'output/rack_10/{scene_name}',
    seed = seed,
    primary_device = 'cuda',
    use_wandb = False,
    wandb = dict(
